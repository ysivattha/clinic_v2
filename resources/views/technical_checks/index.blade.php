...
<form action="/technical"  method="GET">
    <div class="row mb-3">
        <div class="col-3">
            <div class="row">
                <div class="col-4">
        ...
        <div class="col-2 mt-4">
            <div class="row">
                ...
                <div class="col-6">
                    <a type="button"  class="btn btn-danger" href="/technical">សំអាត</a>
                </div>
            </div>
        </div>
    </div>
       ...
       <table class="table table-sm table-bordered " style="width: 100%">
            ...
            <tbody>			
                ...
                @foreach($technicals as $t)
                    ...
                    ?>
                    <tr 
                        @if($t->request_status==5)style="background: #acd1f9;"
                        @elseif($t->request_status==6)style="background: #ffecc7;"
                        @endif
                    >
                        <td>{{$i++}}</td>
                        <td class="text-center">   <a href="{{url('request/detail', $request->id)}}" title="{{__('lb.detail')}}"
                            >{{$request->code}}</a></td>
                        <td 
                        ...
                        <td><a href="{{url('technical/detail', $t->id)}}" title="{{__('lb.detail')}}"
                            >{{$t->item_name}}</a></td>
                        <td>{{$t->date}}</td>
                      ...
                      <td>  
                        ...
                        @endif</td>
                        <td>
                        <a href="{{url('technical/print/'.$t->id)}}" target="_blank" class="btn btn-info btn-xs">
                            <i class="fa fa-print">ស្ទីកឃើ</i>
                        </a>
                            @if($t->request_status==11)
                            <a href="{{url('/doctor-check/print/'.$t->id)}}" target="_blank" class="btn btn-primary btn-xs">
                                <i class="fa fa-print">លទ្ធផល</i>
                            </a>
                            @endif
...
{{--                           --}}
{{--                            @endcandelete--}}
                            <a href="{{url('technical/detail', $t->id)}}" class="btn btn-success btn-xs"  >
