...
<body >
    <table width="100%" style="padding-left: 25px; padding-top: 25px; padding-right: 10px; ">
        <thead>
            <tr>
                <th>
            ...
            <tr>
                <td>
                    <table width="100%" class="header">
                        ...
                        <tr>
                            <td  style="width=:5px;padding:0!important;margin:0!important; font-size: 13px!important;">អត្តលេខ / H.N</td>
                    ...
                    <div style="width: 100%" id="sign_area_cotainer">
                        <div class="sign_area" >
                            ...
                            <p style="margin-left: 25%;"><img src="{{asset($doctor->signature)}}" alt="" width="100"></p>
