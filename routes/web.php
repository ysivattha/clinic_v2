...
Route::group(['middleware' =>'auth'] ,function() 
{
    ...
    Route::get('invoice/get-medicine/{id}', 'InvoiceController@get_medicine');
      ...
      Route::get('request/send-doctor/{id}', 'RequestcheckController@send_doctor');
      Route::get('request/create/{id}', 'RequestcheckController@get_patient');
      Route::get('request/getpatien/{id}' , 'RequestcheckController@get_code');
      Route::get('request/search' , 'RequestcheckController@search')->name('request.search');
      
      //technical check on request detail
      Route::get('technical', 'TechnicalController@index')->name('technical.index');
      Route::get('technical/send-doctor/{id}', 'TechnicalController@send_doctor');
    ...
    Route::post('technical/detail/{id}', 'TechnicalController@send_doc')->name('technical.send');
